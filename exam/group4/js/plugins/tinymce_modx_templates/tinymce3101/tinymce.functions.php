...
//-- added for templates --/
// 10/26/08 - 3:30 pm est
// added template to $plugins and $buttons2 row below
                                $plugins = "style,advimage,advlink,searchreplace,print,contextmenu,paste,fullscreen,nonbreaking,xhtmlxtras,visualchars,media,template";
                                ...
                                $buttons2 = "bold,italic,underline,strikethrough,sub,sup,separator,blockquote,separator,bullist,numlist,outdent,indent,separator,justifyleft,justifycenter,justifyright,justifyfull,separator,styleselect,formatselect,separator,template,styleprops";
                                $buttons3 = "";
                                $buttons4 = "";                         
                    }
                } else {
...
//-- added for templates --/
// 10/26/08 - 3:30 pm est
                $tinymceInit .= "template_external_list_url : \"assets/plugins/tinymce3101/jscripts/tiny_mce/lists/template_list.js\",\n";
// Replace values for the template plugin
// these array pairs will be parsed and replaced in the templates
// see the included templates for example
                $tinymceInit .= "template_replace_values : {
                        username : \"Some User\",
                        staffid : \"991234\"
                },\n";
/////////////////////////////////////
