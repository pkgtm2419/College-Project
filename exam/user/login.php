...
<meta name="author" content="Webcure Technologies">
...
<div class="megamenu_wrapper megamenu_container">
	...
	<ul class="megamenu">
	<li><span class="drop"><a href="index.php">Home</span></li>
	</ul>
</div>	
</nav>
	...
	<div class="row">
		...
		<div class="col-left">
			...
			<ul>
						...
						<li><i class="icon-phone"></i> Telephone: +91-xxxxxx</li>
						<li><i class="icon-phone-sign"></i> L.L.: 0512-xxxxxx</li>
						<li><i class="icon-envelope"></i> Email:</li>
					</ul>
			<hr>
    					<iframe src="" width="600" height="250" frameborder="0" style="border:0"></iframe>
			<br/>
		</div>
		<p>
  ...
  <div class="container">
  	<div class="row">
        ...
        <div class="span4" id="contacts-footer" style="padding-top:40px;">
        	<h4>Contacts</h4>
            <ul>
    					<li><i class="icon-home"></i><span style="font-size:px"></span></li>
						<li><i class="icon-phone"></i><span> Telephone: +91-</span></li>
						<li><i class="icon-phone-sign"></i><span> L.L.: 0512-</span></li>
        ...
        <div class="span4" id="quick-links" style="padding-top:40px;">
        	<h4>Quick links</h4>
            <ul class="list-menu">
    					<iframe src="" width="600" height="150" frameborder="0" style="border:0"></iframe>
			</ul>
            <hr>
