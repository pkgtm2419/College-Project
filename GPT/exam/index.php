...
<link rel="stylesheet" href="hover/css/style.css" type="text/css" media="screen"/>
<link rel="stylesheet" href="hover/css/common.css" type="text/css" media="screen"/>
<link rel="stylesheet" href="hover/css/thirdeffect.css" type="text/css" media="screen"/>
...
<div class="container">
	<div class="row">
		<div class="main">
		<a href="login.php" title="Click Here">
			<div class="view third-effect" style="width:500px; background-color:#0085cf">
				<div style="padding-top:110px;padding-left:107px;">
				<h1 style="color:#fff; width:290px;"><img src="frontdesign/img/login.png" style="" /></h1>
				</div>
			</div>
		</a>	
		<a href="registration.php" title="Click Here">
			<div style="padding-left:490px;">
			<div class="view third-effect" style="width:500px; height:300px;background-color:#0085cf">
				<div style="padding-top:110px;padding-left:107px;">
				<h1 style="color:#fff; width:290px;"><img src="frontdesign/img/registrationnew.png" style="" /></h1>
				</div>
			</div>
			</div>
		</a>	
