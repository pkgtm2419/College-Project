...
<div id="top-bar">
  <div class="topbar-strip">
    ...
    <div class="date-block"> <span class="date1"><?php echo date('l'); ?></span>, <span class="date2"><?php echo date('F'); ?></span> <span class="date3"><?php echo date('d'); ?></span>, <span class="date4"><?php echo date('Y'); ?></span> 	
	</div>
